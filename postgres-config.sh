...
sudo cp -rf /home/"$USER"/anti-hero/config/postgresql.conf /etc/postgresql/14/main/postgresql.conf
sudo cp -rf /home/"$USER"/anti-hero/config/pg_hba.conf /etc/postgresql/14/main/pg_hba.conf
